...
namespace gps {
    ...
    void SkyBox::draw(gps::Shader shader, glm::mat4 viewMatrix)
    {
        shader.useShaderProgram();
        
        //set the view and projection matrices
        glm::mat4 transformedView = glm::mat4(glm::mat3(viewMatrix));
        glUniformMatrix4fv(glGetUniformLocation(shader.shaderProgram, "projectionView"), 1, GL_FALSE, glm::value_ptr(projection*transformedView));
